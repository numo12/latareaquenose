...
<table >
	...
	<section style="background: ;padding: 1px; width: 30%; border-radius: 20px;margin: auto;" ><h1 style="text-align: center;">rompe bucle</h1></section>
	
	<tr><td><label>Incice</label></td>
		<td>Ciudad</td></tr>
...
$ciudades=array("$cl1"=> "$cl11", "$cl2"=> "$cl21", "$cl3"=> "$cl31", "$cl4"=> "$cl41", "$cl5"=> "$cl51");
